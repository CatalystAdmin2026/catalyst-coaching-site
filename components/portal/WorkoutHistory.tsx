  ...
  if (sessions.length === 0) {
    return (
      <div className="border border-dashed border-white/[0.06] px-5 py-6 text-center">
        ...
        <p className="text-gray-700 text-xs mt-1">Your workout history will appear here after your first session.</p>
      </div>
    );
  }
    ...
    <div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 mt-0.5">
                ...
                {s.programWeekNumber && (
                  <span className="text-gray-700 text-[10px]">Week {s.programWeekNumber}</span>
                )}
            ...
            <div className="shrink-0 text-right">
              ...
              <p className="text-gray-700 text-[9px] uppercase tracking-[0.2em]">done</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {sessions.length > 5 && (
        <button
          ...
          className="w-full text-center text-[10px] text-gray-600 hover:text-gray-400 transition-colors py-3 border-t border-white/[0.04] mt-2"
        >
